...
- [#164](https://github.com/nf-core/riboseq/issues/164) - Run StringTie reference-guided assembly on RNA-seq BAMs (`--skip_stringtie false`) and merge per-sample GTFs into a unified annotation ([@pinin4fjords](https://github.com/pinin4fjords))
...
- [#164](https://github.com/nf-core/riboseq/issues/164) - Classify novel transcripts with gffcompare against the full reference and filter to user-configurable class codes via the new `--gffcompare_class_codes` parameter (default `u`, intergenic only; stranded users may add `x` for antisense) ([@pinin4fjords](https://github.com/pinin4fjords))
