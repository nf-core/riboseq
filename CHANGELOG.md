...
- [#143](https://github.com/nf-core/riboseq/pull/143) - Remove pipeline-level fixed seeds from production read subsampling and STAR alignment ([@pinin4fjords](https://github.com/pinin4fjords))
